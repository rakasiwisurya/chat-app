...
function Avatar() {
  ...
  const getProfilePicture = async () => {
    ...
    try {
      ...
      timeout = setTimeout(getProfilePicture, 60000);
    }
  };
    ...
    <Container>
      {isLoading ? (
        ...
        <>
          ...
          <button className="submit-btn" onClick={setProfilePicture} disabled={isSubmitted}>
            Set as Profile Picture {isSubmitted && "..."}
          </button>
        </>
      )}
    </Container>
